...
function Recipe(props) {
    ...
    return (
        <div className='container w-[100vw]'>
            <div className='heading-line w-[100vw] p-8 text-[1.5em] mb-5 text-center text-mid '>
            ...
            <div className='flexbox w-[100vw] flex flex-wrap justify-center gap-3'>
                {
                ...
                {/* <div className='flexItem shadow-lg bg-white rounded-lg overflow-hidden w-[30vw] m-2'>
                    <div className='img-wrapper'>
